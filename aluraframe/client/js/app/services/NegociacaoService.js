    ...
    _createClass(NegociacaoService, [{
        ...
        value: function obterNegociacoesDaSemana() {
            ...
            return this._http.get('negociacoes/semana').then(function (negociacoes) {
                ...
                console.log(erro);
                throw new Error(_this._mensagem.texto = 'Não foi possível obter as negociações da semana.');
            });
        }
    }, {
        ...
        value: function obterNegociacoesDaSemanaAnterior() {
            ...
            return this._http.get('negociacoes/anterior').then(function (negociacoes) {
                ...
                console.log(erro);
                throw new Error(_this2._mensagem.texto = 'Não foi possível obter as negociações da semana anterior.');
            });
        }
    }, {
        ...
        value: function obterNegociacoesDaSemanaRetrasada() {
            ...
            return this._http.get('negociacoes/retrasada').then(function (negociacoes) {
                ...
                console.log(erro);
                throw new Error(_this3._mensagem.texto = 'Não foi possível obter as negociações da semana retrasada.');
            });
        }
    }, {
